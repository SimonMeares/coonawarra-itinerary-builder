...
const BUILT_IN_PRODUCTS = [
  ...
  {id:"p-ottelia",rezdy:null,category:"Experience Components",name:"Ottelia",subtitle:"Seasonal dining · Coonawarra",type:"component",duration:null,departures:null,location:"Coonawarra",minGuests:null,maxGuests:null,pricing:{structure:"component",tiers:[],note:"Included in select tours and packages"},tags:["Dining","Seasonal","Wine"],description:"One of Coonawarra's most celebrated dining rooms, set within the Leconfield and Richard Hamilton cellar door. The menu changes with the seasons and is built entirely around the finest produce the region and surrounding Limestone Coast have to offer. Lunch here is a genuine highlight of any Coonawarra itinerary — elegant without being formal, with a wine list that does justice to the surroundings.",inclusions:["Seasonal set-menu lunch, built around the finest Limestone Coast produce","Matched Coonawarra and regional wine list","Set within the Leconfield and Richard Hamilton cellar door, Coonawarra"]},
