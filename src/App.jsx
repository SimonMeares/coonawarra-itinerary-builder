...
const BUILT_IN_PRODUCTS = [
  ...
  {id:"p-heritage-treasures",rezdy:"PLVMQJ",category:"Day Tours",name:"Heritage & Hidden Treasures",subtitle:"Naracoorte Caves & Yallum Park · Min 2 / Max 4",type:"private",duration:"8 hrs",schedule:"9:00 – 17:00",departures:"Daily",location:"Naracoorte · Penola",minGuests:2,maxGuests:4,pricing:{structure:"tiered_per_person_by_group",tiers:[{label:"2 guests",pax:2,retail:795},{label:"3 guests",pax:3,retail:695},{label:"4 guests",pax:4,retail:595}],note:"Per person, priced by group size"},tags:["Caves","Heritage","History"],description:"A privately hosted day that moves between two of the region's most extraordinary places — below ground and more than a century of history above it. The morning is spent in the Naracoorte Caves with a senior national park guide who takes you beyond the standard visitor areas. You will go 'under the ledge' to active fossil dig sites inside Victoria Fossil Cave and Blanche Cave, areas typically closed to the public. You may encounter scientists at work and visit the Fossil Lab, where ancient bones are cleaned and catalogued. After a seasonal set-menu lunch at Ottelia in Coonawarra, the afternoon unfolds inside Yallum Park — one of Australia's finest Victorian-era homesteads, built for Coonawarra founder John Riddoch. Fourteen-foot ceilings, marble mantelpieces, original English wallpapers and a billiard room unchanged for generations.",inclusions:["Private 3-hour guided cave experience, UNESCO World Heritage–listed Naracoorte Caves — Victoria Fossil Cave and Blanche Cave, including access to active fossil dig sites","Fossil Lab visit — observe scientists at work on prehistoric discoveries","Seasonal set-menu lunch at Ottelia, Coonawarra — fresh local produce with matched estate wines","Private guided tour of Yallum Park Mansion, Penola — a Victorian-era homestead built for Coonawarra founder John Riddoch","Premium Mercedes-Benz transport throughout the day, driven by your hosts","Pick-up and drop-off, Penola / Coonawarra / Naracoorte region","All entry fees included"]},
  {id:"p-immerse-day",rezdy:"PFLB9E",category:"Day Tours",name:"Immerse Yourself in Coonawarra",subtitle:"Full day private wine tour · Min 2 / Max 6",type:"private",duration:"6.5 hrs",schedule:"10:30 – 17:00",departures:"Daily",location:"Coonawarra · Penola",minGuests:2,maxGuests:6,pricing:{structure:"per_adult",tiers:[{label:"Per adult",retail:395}],note:null},tags:["Wine","Cellar Door","Dining"],description:"A full day in the company of the people who make Coonawarra's wine great. Privately hosted from pick-up to drop-off, this tour moves through four to five of the region's most celebrated cellar doors at a relaxed pace — from family-owned boutique estates to iconic producers along the Terra Rossa strip. You will taste reserve and icon wines, hear the stories behind the region's most distinctive bottles and enjoy a private tour of the historic 1896 cellar at Wynns Coonawarra Estate. Lunch is a seasonal set-menu at Ottelia, one of Coonawarra's most awarded dining rooms, or an alternate menu at Parker Coonawarra Estate on Tuesday and Wednesday. The tour is yours to shape — let us know what interests you most, or simply let the day unfold in our hands.",inclusions:["Privately hosted tour of four to five premium cellar doors along Coonawarra's Terra Rossa strip","Reserve and icon wine tastings, all fees included","Private cellar tour at Wynns Coonawarra Estate — the region's founding winery, established 1896","Seasonal set-menu lunch at Ottelia, Coonawarra, or Parker Coonawarra Estate (Tuesday and Wednesday)","Premium transport — 300 Series LandCruiser, driven by your hosts","Pick-up and drop-off, Penola / Coonawarra accommodation","Historical and regional commentary throughout the day"]},
  {id:"p-unearthed",rezdy:"PTGHJM",category:"Day Tours",name:"Coonawarra Unearthed",subtitle:"Full day small-group wine tour · Min 2 / Max 10",type:"small_group",duration:"6 hrs",schedule:"11:00 – 17:00",departures:"Daily",location:"Coonawarra · Penola",minGuests:2,maxGuests:10,pricing:{structure:"per_adult",tiers:[{label:"Per adult",retail:215}],note:null},tags:["Wine","Cellar Door","Small Group"],description:"Coonawarra's best cellar doors in one well-paced day, hosted by Simon or Kerry alongside a small group of fellow travellers. Visit four to five wineries along the famous Terra Rossa strip — from the pioneering cellar at Wynns Coonawarra Estate, established in 1896, to family-owned estates that rarely appear on itineraries. En route, a stop at the historic Coonawarra Railway Siding tells the story of how this region became one of Australia's most celebrated wine addresses. Lunch is a sumptuous gourmet produce platter and a glass of wine at an iconic family winery. Optional upgrades are available, including a Wynns Icon tasting session, a set-menu lunch at Ottelia or a wine and chocolate pairing at Patrick of Coonawarra.",inclusions:["Wine tastings at four to five cellar doors along Coonawarra's Terra Rossa strip","Behind-the-scenes at Wynns Coonawarra Estate — private cellar visit and regional history","Historic Coonawarra Railway Siding stop — stories from the founding of the region","Sumptuous gourmet produce platter with a glass of wine at a family-owned winery","Premium transport, driven by your hosts","Pick-up and drop-off, Penola / Coonawarra accommodation","All tasting fees included","Optional upgrade: Wynns Icon Series tasting, Ottelia set-menu lunch or Patrick wine and chocolate pairing"]},
  {id:"p-highlights",rezdy:"PBBRC2",category:"Day Tours",name:"Coonawarra Highlights",subtitle:"Half day small-group wine tour · Min 2 / Max 10",type:"small_group",duration:"4.5 hrs",schedule:"12:30 – 17:00",departures:"Daily",location:"Coonawarra · Penola",minGuests:2,maxGuests:10,pricing:{structure:"per_adult",tiers:[{label:"Per adult",retail:185}],note:null},tags:["Wine","Cellar Door","Half Day"],description:"A perfectly paced half day along Coonawarra's famous Terra Rossa strip — vivid red soil, ancient limestone and rows of vines that have been producing some of Australia's most celebrated wine for over a century. Visit three to four cellar doors, meet the makers and hear the stories behind the bottles. The afternoon includes a sumptuous gourmet produce platter with a glass of wine at a family-owned estate. Ideal for guests arriving mid-morning, those with an early evening commitment or anyone who wants a genuine taste of the region without filling the whole day.",inclusions:["Wine tastings at three to four cellar doors along Coonawarra's Terra Rossa strip","Sumptuous gourmet produce platter with a glass of wine at a family-owned winery","Premium transport, driven by your hosts","Pick-up and drop-off, Penola / Coonawarra accommodation","All tasting fees included"]},
  {id:"p-warrawindi-escape",rezdy:"PTG4V2",category:"Stay & Tour Packages",name:"A Warrawindi Escape",subtitle:"Luxury off-grid retreat & private touring · 2 Nights · Penola",type:"private",duration:"2 Nights · 1 Day",departures:"On request",location:"Penola · Limestone Coast",accommodation:"Blue Wren Retreat, Warrawindi Escapes",minGuests:2,maxGuests:2,pricing:{structure:"per_couple",tiers:[{label:"Per couple",retail:3975}],note:"On request"},tags:["Stay & Tour","Off-Grid","Farm","Wildlife"],description:"Two nights at the architecturally designed Blue Wren Retreat on a 3,000-acre private sustainable farm, paired with a fully hosted day across the Limestone Coast.",inclusions:["Two nights at the Blue Wren Retreat, architecturally designed off-grid luxury","Cedar hot tub, open fireplace and sweeping bushland views","Premium Coonawarra wine and chocolate on arrival","Generous breakfast provisions throughout your stay","Privately hosted full-day tour, UNESCO Naracoorte Caves and premium Coonawarra tastings","Regional produce luncheon","Boutique olive grove tasting","Private kangaroo sanctuary encounter"]},
  {id:"p-wagyu-wine-stay",rezdy:"PYVHSJ",category:"Stay & Tour Packages",name:"Wagyu, Wine & Stay",subtitle:"Mayura Steakhouse · Penola apartment · Hosted Coonawarra tour",type:"private",duration:"2 Nights · 2 Days",departures:"Wed–Sun",location:"Penola · Coonawarra",accommodation:"Coonawarra Experiences Apartment, Penola",minGuests:2,maxGuests:2,pricing:{structure:"per_couple",tiers:[{label:"Per couple",retail:1990}],note:"Adults only · Min/Max 2 · Dining Thu, Fri & Sat"},tags:["Stay & Tour","Wagyu","Dining","Wine"],description:"An indulgent two-night package built around three of the Limestone Coast's signature experiences. Settle into the Coonawarra Experiences apartment in the heart of Penola — a quiet, well-appointed base with everything you need for a comfortable stay. On one evening, a private transfer takes you to Mayura Wagyu Steakhouse for a five-course chef's table degustation of full-blood Wagyu, matched with museum-release Coonawarra wines. The following day, Simon and Kerry host you through four to five of the region's finest cellar doors, with a produce platter at a family estate and an exclusive visit to Wynns Coonawarra Estate.",inclusions:["Two nights at the Coonawarra Experiences Apartment, Penola — queen bedroom, living area and heated bathroom floors","Coonawarra wine and Cuvée chocolates on arrival","Continental breakfast provisions throughout your stay","Private return transfers to Mayura Wagyu Steakhouse","Chef's table degustation — full-blood Wagyu with matched museum-release Coonawarra wines","Fully hosted wine tour — exclusive tastings at four to five premium cellar doors","Sumptuous produce platter with wine at a family estate","Exclusive visit to Wynns Coonawarra Estate — private cellar walking tour"]},
  ...
  {id:"p-immerse-package",rezdy:"PEB4NQ",category:"Stay & Tour Packages",name:"Immerse Yourself in Coonawarra (Package)",subtitle:"Stay & tour · 2 Nights · Penola",type:"private",duration:"2 Nights · 1 Day",departures:"Daily · On request",location:"Penola · Coonawarra",accommodation:"Coonawarra Experiences Apartment, Penola",minGuests:2,maxGuests:null,pricing:{structure:"per_couple",tiers:[{label:"Per couple",retail:945}],note:null},tags:["Stay & Tour","Wine","Cellar Door"],description:"The ideal way to settle into Coonawarra. Two nights in our private guest apartment in the heart of Penola — a warm, comfortable base with everything you need — followed by a full day among the region's finest cellar doors with Simon and Kerry as your guides. This is the package that gives independent travellers the best of both worlds: somewhere personal to come back to each evening and a hosted day that opens doors you simply cannot open on your own. Arrivals are welcomed with a bottle of Coonawarra wine and Cuvée chocolates. Continental breakfast provisions are restocked each morning.",inclusions:["Two nights at the Coonawarra Experiences Apartment, Penola — queen bedroom, living area and heated bathroom floors","Coonawarra wine and Cuvée chocolates on arrival","Continental breakfast provisions throughout your stay","Fully hosted wine tour — exclusive tastings at four to five premium cellar doors","Sumptuous gourmet produce platter with wine through the day","Exclusive visit to Wynns Coonawarra Estate — private cellar walking tour","Premium transport on tour day, driven by your hosts","All tasting fees included"]},
  ...
  {id:"p-mayura",rezdy:null,category:"Experience Components",name:"Mayura Wagyu Steakhouse",subtitle:"Chef's table degustation · Penola",type:"component",duration:null,departures:"Thu–Sat (private on request)",location:"Penola",minGuests:null,maxGuests:null,pricing:{structure:"component",tiers:[],note:"Priced as part of a package or on application"},tags:["Wagyu","Dining","Chef's Table"],description:"An exceptional evening at Mayura Wagyu Steakhouse — one of the most celebrated dining experiences on the Limestone Coast. Located near Penola, Mayura is renowned for its full-blood Japanese Wagyu raised on the property and served across a multi-course chef's table degustation. Each course is paired with premium local wines chosen to complement the depth of the beef. The chef's table seats a maximum of ten guests. Availability is Thursday, Friday and Saturday evenings only. Private transfers from Penola or Coonawarra accommodation are available, with the vehicle and driver waiting on site throughout the evening.",inclusions:["Multi-course chef's table degustation, full-blood Wagyu raised on Mayura Station","Matched premium local wines with each course","Chef's table — maximum ten seats","Available Thursday, Friday and Saturday evenings only","Private return transfers from Penola or Coonawarra accommodation available"]},
  {id:"p-wynns",rezdy:null,category:"Experience Components",name:"Wynns Coonawarra Estate — Icon Tasting",subtitle:"VIP private tasting · Historic 1896 Gables winery",type:"component",duration:null,departures:null,location:"Coonawarra",minGuests:null,maxGuests:null,pricing:{structure:"component",tiers:[],note:"Included in most day tours and packages"},tags:["Wine","Cellar Door","Icon"],description:"A private tasting experience inside the historic Gables winery at Wynns Coonawarra Estate — the founding winery of the region, built in 1896. Guided by a senior member of the Wynns team, this session moves through the Icon Series and museum-release wines that have defined Coonawarra's reputation on the world stage. The old stone cellar, the heritage winemaking equipment and the depth of the wines make this one of the most memorable stops on any Coonawarra itinerary.",inclusions:["Private tasting of Wynns Icon Series and museum-release wines, guided by senior staff","Behind-the-scenes access to the historic 1896 Gables winery","Regional history and winemaking commentary throughout"]},
  {id:"p-kangaroo-sanctuary",rezdy:null,category:"Experience Components",name:"Private Kangaroo Sanctuary",subtitle:"Not open to the public",type:"component",duration:null,departures:null,location:"Limestone Coast",minGuests:null,maxGuests:null,pricing:{structure:"component",tiers:[],note:"Included in select tours and packages"},tags:["Wildlife","Kangaroos","Private"],description:"A private kangaroo sanctuary not open to the public — one of those rare experiences that stays with guests long after the trip ends. Meet the carers, hear the stories behind the animals in their care and spend time feeding and interacting with orphaned joeys in a gentle, unhurried environment. Exclusive to Coonawarra Experiences guests.",inclusions:["Private access to the kangaroo sanctuary — not open to the general public","Hosted encounter with rescued and resident kangaroos","Opportunity to feed and interact with orphaned joeys","Exclusive to Coonawarra Experiences guests"]},
  {id:"p-blue-wren",rezdy:null,category:"Experience Components",name:"Blue Wren Retreat — Warrawindi Escapes",subtitle:"Off-grid luxury · 3,000-acre sustainable farm · Penola",type:"component",duration:null,departures:"On request",location:"Penola",minGuests:null,maxGuests:null,pricing:{structure:"component",tiers:[],note:"Included in A Warrawindi Escape or on application"},tags:["Accommodation","Off-Grid","Farm"],description:"Nestled in the lush bushland of Warrawindi's 3,000-acre working sustainable farm, the Blue Wren is a two-bedroom retreat designed for two couples or friends looking to disconnect and unwind. Wake to the sounds of the bush on the private deck, soak in the cedar hot tub while watching farm animals and wildlife, and wind down around the outdoor fire pit beneath a vast country sky. A fully-equipped kitchen makes it easy to settle in for the evening, and with two king bedrooms and two ensuite bathrooms, there is plenty of space for everyone to spread out.",inclusions:["Two king bedrooms — second bedroom convertible to two king single beds","Two ensuite bathrooms, each with a bath","Cedar hot tub with views over the farm and wildlife","Outdoor fire pit","Private deck overlooking the bushland landscape","Fully-equipped kitchen","Welcome provisions on arrival"]},
  {id:"p-brolga",rezdy:null,category:"Experience Components",name:"The Brolga — Warrawindi Escapes",subtitle:"Off-grid couples retreat · King bed, spa bath & fire pit · Penola",type:"component",duration:null,departures:"On request",location:"Penola",minGuests:null,maxGuests:null,pricing:{structure:"component",tiers:[],note:"Available as part of a package or on application"},tags:["Accommodation","Off-Grid","Farm"],description:"An intimate off-grid retreat for couples, set on Warrawindi's 3,000-acre working sustainable farm. The Brolga's standout feature is the spa bath that opens directly onto open paddocks — soak and watch farm animals and native wildlife graze in the distance. A king-sized bed, open fireplace, private veranda and outdoor fire pit make this a deeply comfortable base for exploring the Limestone Coast at your own pace.",inclusions:["King bedroom","Spa bath opening directly onto open paddocks — farm and wildlife views","Open fireplace","Private veranda and outdoor fire pit","Fully-equipped kitchen","Smart TV and Bluetooth speaker","Complimentary Wi-Fi","Reverse cycle heating and cooling","Welcome provisions on arrival"]},
  {id:"p-ottelia",rezdy:null,category:"Experience Components",name:"Ottelia",subtitle:"Tasting room and restaurant · Coonawarra",type:"component",duration:null,departures:null,location:"Coonawarra",minGuests:null,maxGuests:null,pricing:{structure:"component",tiers:[],note:"Included in select tours and packages"},tags:["Dining","Seasonal","Wine"],description:"Ottelia is a family-owned tasting room and restaurant in the heart of Coonawarra, run by two generations of the Innes family. It has become one of the most respected places to eat and drink on the Limestone Coast — recognised by Gourmet Traveller for its effortless charm and the kind of hospitality that comes from people who genuinely love what they do. The menu is seasonal and changes with what the region is producing. The wine list draws on the full breadth of the Limestone Coast's wine regions, from Coonawarra and Wrattonbully through to Padthaway, Robe, Mt Benson and Mount Gambier. Lunch at Ottelia is an unhurried, considered occasion and a genuine highlight of any Limestone Coast itinerary.",inclusions:["Seasonal lunch at Ottelia Tasting Room and Restaurant, Coonawarra","Wine list showcasing the Limestone Coast's key wine regions","Hosted by the Innes family — two generations of winemakers and restaurateurs"]},
  {id:"p-confido",rezdy:null,category:"Experience Components",name:"Confido Olive Oil",subtitle:"Boutique olive grove tasting · Coonawarra",type:"component",duration:null,departures:null,location:"Coonawarra",minGuests:null,maxGuests:null,pricing:{structure:"component",tiers:[],note:"Included in select tours and packages"},tags:["Olive Oil","Produce","Artisan"],description:"A beautifully immersive tasting experience hosted by the owners of Confido in their working olive grove in Coonawarra. Learn about the production of premium extra-virgin olive oil from paddock to bottle, taste the oils at their freshest and take home an understanding of what makes a great EVOO. A genuine paddock-to-plate experience in a setting that feels a long way from the usual tourist trail.",inclusions:["Hosted olive oil tasting in the working olive grove — led by the Confido producers","Freshly pressed extra-virgin olive oil across multiple varieties","Paddock-to-plate insight into the production process"]},
  ...
  {id:"p-farewell",rezdy:null,category:"Experience Components",name:"Farewell from the Limestone Coast",subtitle:"A personal farewell from Simon & Kerry Meares",type:"component",duration:null,departures:null,location:"Limestone Coast",minGuests:null,maxGuests:null,pricing:{structure:"component",tiers:[],note:null},tags:["Farewell"],description:"The Limestone Coast is not a place that lets go of you easily. As you head home, we hope you are carrying with you something of what makes this region so hard to leave. The pace of the land. The warmth of the people you met along the way. Perhaps a few bottles that will taste even better when you open them back home and remember exactly where you were.\n\nThank you for taking the time to come here. Every guest who discovers this corner of South Australia becomes part of the story we are building about this place, and your visit matters more to us than we can easily put into words.\n\nWe hope you are leaving with a genuine feel for the Limestone Coast and the people who call it home. We hope you have come to know this region a little better than when you arrived.\n\nSafe travels on your onward journey. We hope it will not be long before the road brings you back to us.\n\nWith warm wishes,\nSimon and Kerry Meares\nCoonawarra Experiences",inclusions:[]},
];
    ...
    days:[
      {
        ...
        internalNotes:"",
        items:[
          {id:"s_bw3n_d1_i1",productId:"p-blue-wren",notes:"Welcome wine and artisan chocolate on arrival.",overrides:{}},
    ...
    days:[
      {
        ...
        items:[
          {id:"s_w2n_v2_d1_i1",productId:"p-brolga",notes:"Check in from 3:00 PM. Welcome wine and artisan chocolate on arrival.",overrides:{}},
...
function printCompressed(title){
  ...
  imgs.forEach(img=>{img.src=cdnSrc(img.src,600);});
...
@media print{
  ...
  .print-break{page-break-before:always;break-before:page;padding-top:8mm;}
  ...
  @page :first{margin:0;}
  .preview-wrapper{padding:0 8px!important;}
